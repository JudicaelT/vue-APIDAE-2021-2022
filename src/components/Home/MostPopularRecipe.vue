<template>
    <div class="card rounded-rounder overflow-hidden mx-3">
        ...
        <div class="h-0 d-flex justify-content-center align-items-center">
            <router-link class="btn btn-light btn-height position-absolute rounded-circle d-flex align-items-center"
        ...
        <div class="card-body text-center py-4">
            ...
            <router-link class="btn border-2 rounded-0 font-weight-bold btn-outline-dark" :to="`/recette/${id}`">Voir
            </router-link>
        </div>
        <div class="h-0 d-flex justify-content-center align-items-center">
            <router-link class="btn btn-light btn-height position-absolute rounded-circle d-flex align-items-center"
