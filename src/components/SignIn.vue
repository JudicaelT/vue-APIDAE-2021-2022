    ...
    <div class="row pb-5">
      <div class="col d-flex justify-content-center align-items-center">
        ...
        >
          ...
          <input class="form-control rounded py-4 border-0 bg-grey" placeholder="ex : john.doe@gmail.com" type="mail" name="email" />
          ...
          <label class="form-label mt-3" for="login">Répéter le mot de passe :</label>
          <input class="form-control rounded py-4 border-0 bg-grey" type="password" name="password-repeat" />
      ...
      <div class="d-none d-md-block col-4 py-5 rounded-rounder-left" :style="{'background-image': 'url('+ getImageUrl('sign_in_background.jpg') +')'}"></div>
    </div>
  </div>
</template>
